...
export async function GET(req: NextRequest) {
  ...
  let query = serviceClient()
    ...
    .select('*, client:coach_clients(id, first_name, last_name, email), subscription:client_subscriptions(id, formula:coach_formulas(name, price_eur))')
    .eq('coach_id', user.id)
...
export async function POST(req: NextRequest) {
  ...
  const { client_id, subscription_id, amount_eur, status, payment_method, payment_date, due_date, description, reference } = body
