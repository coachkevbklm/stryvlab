...
const WELCOME_SCREENS = [
  ...
  },
  {
    ...
    title: () => 'Ton dashboard, ton point de départ',
    subtitle: 'Ton dashboard centralise tout. La séance du jour, les bilans envoyés par ton coach, et les messages importants apparaissent directement ici. Ton profil te permet de personnaliser ton suivi.',
    rows: [
      { icon: ClipboardList, text: 'Bilans à compléter visibles directement sur l\'accueil' },
      { icon: Bell, text: 'Actions prioritaires toujours en premier plan' },
