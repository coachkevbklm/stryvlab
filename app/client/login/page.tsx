      ...
      <div className="bg-white/[0.02] rounded-xl p-6 w-full max-w-sm">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <button
            type="submit"
            disabled={isPending}
            className="mt-1 flex h-[48px] items-center justify-between rounded-xl bg-[#f2f2f2] pl-5 pr-2 transition-all hover:bg-[#e8e8e8] active:scale-[0.99] disabled:opacity-50"
          >
