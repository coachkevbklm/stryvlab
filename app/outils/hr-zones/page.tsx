...
export const metadata: Metadata = {
  ...
  description:
    "Calculateur de zones cardiaques scientifique. Méthode Karvonen (FC réserve). Formules Tanaka 2001 & Gulati 2010. 6 zones ACSM validées.",

  openGraph: {
    title: "HR Zones Calculator Pro | STRYV lab",
    description:
      "Définissez vos zones d'intensité cardiaque pour un entraînement optimal.",
