...
// STRYVR logo SVG (monochrome dark)
function StryvrLogo() {
  return (
    <svg viewBox="0 0 24 24" width="20" height="20" fill="none" xmlns="http://www.w3.org/2000/svg">
      <text x="50%" y="16" textAnchor="middle" fontSize="11" fontWeight="900" fill="#0d0d0d" fontFamily="sans-serif">S</text>
    </svg>
  )
}
