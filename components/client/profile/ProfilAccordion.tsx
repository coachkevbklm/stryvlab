      ...
      <div className="bg-[#111111] rounded-2xl p-4 flex items-center gap-4">
        ...
        {streak && (
          <div className="text-right shrink-0">
            <p className="text-[22px] font-black text-[#f2f2f2] leading-none">
    ...
    <div className="space-y-3">
      <div className="grid grid-cols-3 gap-2">
        <div className="bg-white/[0.03] rounded-xl p-3 text-center">
          <p className="text-[20px] font-black text-[#f2f2f2] leading-none mb-1">
            {streak.current_streak}
          </p>
          <p className="text-[9.5px] font-medium text-white/40">
            {t("profil.streakCurrent")}
          </p>
        </div>
        <div className="bg-white/[0.03] rounded-xl p-3 text-center">
          <p className="text-[20px] font-black text-white leading-none mb-1">
            {streak.total_points}
          </p>
          <p className="text-[9.5px] font-medium text-white/40">
            {t("profil.pointsTotal")}
          </p>
        </div>
        <div className="bg-white/[0.03] rounded-xl p-3 text-center">
          <p
            className={`text-[13px] font-black leading-none mb-1 ${levelColor}`}
          >
            {streak.level}
          </p>
          <p className="text-[9.5px] font-medium text-white/40">
      ...
      <div className="flex items-center justify-between">
        ...
        <p className="text-[12px] font-bold text-white">
          {streak.longest_streak} {t("profil.days.plural")}
        </p>
      </div>
    </div>
  );
