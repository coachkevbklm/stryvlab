 ...
 */
export function getAllMuscles(exercise: Parameters<typeof getMuscleActivation>[0]): Set<MuscleGroup> {
 ...
 */
export function detectMuscleGroups(exercises: Parameters<typeof getMuscleActivation>[0][]): MuscleActivation {
  const primary = new Set<MuscleGroup>()
  const secondary = new Set<MuscleGroup>()
